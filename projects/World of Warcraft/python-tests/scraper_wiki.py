...
requests_cache_spec = importlib.util.find_spec("requests_cache")
AsyncCachedSession = None if requests_cache_spec is None else getattr(
    importlib.import_module("requests_cache"), "AsyncCachedSession", None
)
