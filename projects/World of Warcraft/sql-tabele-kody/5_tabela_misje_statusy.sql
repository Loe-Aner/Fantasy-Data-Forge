...
CREATE TABLE dbo.MISJE_STATUSY (
  ...
  CONSTRAINT FK_MISJE_STATUSY_MISJE FOREIGN KEY (MISJA_ID_MOJE_FK) REFERENCES dbo.MISJE(MISJA_ID_MOJE_PK),
...
ON dbo.MISJE_STATUSY (MISJA_ID_MOJE_FK, SEGMENT, PODSEGMENT, DATA_STATUS DESC)
;

CREATE UNIQUE INDEX UX_MISJE_STATUSY_ORYGINAL
ON dbo.MISJE_STATUSY (MISJA_ID_MOJE_FK, SEGMENT, PODSEGMENT)
